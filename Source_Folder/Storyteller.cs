...
namespace AvaliMod
{
    ...
    public class NesiStoryTeller : StorytellerComp
    {
        ...
        public override IEnumerable<FiringIncident> MakeIntervalIncidents(IIncidentTarget target)
        {
            ...
            int incCount = IncidentCycleUtility.IncidentCountThisInterval(target, Find.Storyteller.storytellerComps.IndexOf(this), this.Props.minDaysPassed, this.Props.onDays, this.Props.offDays, this.Props.minSpacingDays,min, max, num)*new Random(Find.World.ConstantRandSeed).Next(1,3);
            for (int i = 0; i < incCount+added; i++)
            {
                ...
                if (inc != null && incCount+added+1==i)
                {
